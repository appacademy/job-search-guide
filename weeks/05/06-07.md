...
- [x] Explain the time complexity of Quicksort
- [x] Explain the partition method
- [x] What is partial function application?
- [x] What is the difference between class inheritance and class composition?
- [x] What is method overriding?
- [x] What is polymorphism?
- [x] What are class fields and class methods?
- [x] How do static and dynamic languages treat interfaces differently?
- [x] Compare and contrast CSRF and XSS. How do you prevent them?
