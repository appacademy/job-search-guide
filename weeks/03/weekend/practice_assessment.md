...
1. 1.) Choose the correct statement(s) about heaps
...
1. 2.) Which statement(s) about the page lifecycle is/are correct?
...
1. 3.) Select the correct statement(s) about React/Redux
...
1. 4.) Choose the correct statement(s) about AJAX and XHR
...
1. 5.) Which statement(s) about heaps and heapsort is/are correct?
...
1. 6.) Choose the correct statement(s) about variables in JavaScript
...
1. 7.) Choose the correct statement(s) about CORS and same-origin policy
...
1. 8.) Choose the correct statement(s) about MergeSort
...
1. 9.) Select the correct statement(s) about strict mode and the `rest` and `spread` operators
...
1. 10.) Which statement(s) about SQL is/are correct?
