...
- [x] What is a CSRF Attack?
- [x] How can you prevent CSRF Vulnerabilities?
- [x] What are the steps of a `try..catch` block in Javascript?
- [x] What type of errors to `try..catch` blocks work for?
- [x] When creating a custom error, what attributes should it have?
