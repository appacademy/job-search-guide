...
1. 1.) Select the correct statement(s) about recursion
...
1. 2.) What is the correct output of this code:
  ```javascript
    console.log(b);
    console.log(a);
  ...
  * E)
  ```javascript
    ...
    { name: 'win' }
  ```
1. 3.) Select the correct statement(s) about Redux
...
1. 4.) Select the correct statement(s) about HTTP methods and status codes
...
1. 5.) Which statement(s) about recursion and iteration is/are correct?
...
1. 6.) Select the correct statement(s) about the `new` keyword
...
1. 7.) Choose the correct statement(s) about Dynamic Programming
...
1. 8.) Choose the correct statement(s) about event bubbling
...
1. 9.) Select the correct statement(s) about HTTP methods
...
1. 10.) Choose the correct statement(s) about HTTPS
